...
**Status:** ✅ Fully Supported (Dot Notation - Fixed 2026-01-31)
...
**IMPORTANT:** Modules are resolved **relative to the source file's location**, not the current working directory.
...
// (relative to where main.naab is located)

// This works regardless of your current working directory!
```
...
### Version 1.1 (2026-01-31 - Updated)

**Bug Fix Applied:**
- ✅ **FIXED ISS-035:** Module resolution now correctly uses source file's directory, not CWD
- ✅ **Root Cause:** `Interpreter::setSourceCode()` was not setting `current_file_`
- ✅ **Fix:** Modified `interpreter.cpp` line ~424 to set `current_file_ = std::filesystem::absolute(filename).string()`
- ✅ **Testing:** Verified imports work regardless of working directory

### Version 1.0 (2026-01-31 - Initial)
...
- Aliases: ✅ Supported
- Module resolution: ✅ **Fixed - now correctly relative to source file**
