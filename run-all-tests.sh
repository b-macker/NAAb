...
#
#  168s  test_failure_mode_map.sh      <- the pace-setter (96 stub-backed runs:
#                                      16 cells x 6 arms, short and long)
...
#
# 600s is ~3.5x the 168s ceiling, which still holds if a Windows runner is 2-3x
